    ...
    <Layout>
      <div className="w-full">
        <GalleryContext.Provider value={{ state: galleryState, setState: setGalleryState }}>
          <div className="relative flex w-full flex-1 flex-col overflow-y-auto px-3 sm:px-4">
            <IconX className="absolute right-3 top-4 mr-2 h-7 w-7 cursor-pointer text-gray-400 sm:right-4" onClick={onBack} />
            <div className="mt-4 flex w-full flex-1 flex-col overflow-y-auto">
              <div className="flex h-full flex-col overflow-y-auto">
                <div className="flex h-16 w-full items-center justify-between px-3 pb-4 sm:px-4">
                  <LanguageTabSwitcher />
                  <DictRequest />
                </div>
                <ScrollArea.Root className="flex-1 overflow-y-auto">
                  <ScrollArea.Viewport className="h-full w-full ">
                    ...
                    <div className="flex w-full items-center justify-center px-3 pb-10 pt-[20rem] text-gray-500 sm:px-4">
